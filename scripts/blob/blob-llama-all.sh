...
for seed in 1 2 3
do 
    name=$modelwrapper-$dataset-eps$eps-kllr$kllr-beta$beta-gamma$gamma-seed$seed
    ...
    --checkpoint --checkpoint-dic-name $name \
    --bayes-train-n-samples 1 --bayes-eval-n-samples $sample --bayes-eval-n-samples-final $sample --bayes-final-beta 0.18
done
done
done
