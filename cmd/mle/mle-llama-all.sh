...
for dataset in winogrande_m
do
for seed in 1 2 3
do 
    name=$modelwrapper-$dataset-seed$seed
    python -m accelerate.commands.launch --num_processes=2 --gpu_ids="2,3" --main_process_port=20000 run/main.py --dataset-type mcdataset --dataset $dataset \
